						...
						<ul role="list" class="flex flex-1 flex-col gap-y-7">
							<li>
								<ul role="list" class="-mx-2 space-y-1">
									<li>
										<!-- Current: " ", Default: "text-gray-700 hover: hover:" -->
										<a
											href="/home"
											class={`${
												$page.url.pathname === `/${$page.params.orgid}/home`
													? 'bg-gray-200 text-slate-600'
													: 'text-gray-700 hover:text-slate-600'
											} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold`}
										>
											<HomeIcon class=" h-4 my-auto text-[#0833a8]" />
											Home
										</a>
									</li>
									<li>
										<a
											href="#"
											class="text-gray-700 hover: hover: group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
										>
											<svg
												class="h-6 w-6 shrink-0 text-gray-400 group-hover:"
												fill="none"
												viewBox="0 0 24 24"
												stroke-width="1.5"
												stroke="currentColor"
							...
							<li>
								...
								<ul role="list" class="-mx-2 mt-2 space-y-1">
									<li>
										...
										>
											<span
												class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium text-gray-400 border-gray-200 group-hover:border-indigo-600 group-hover:"
												>H</span
											>
							...
							<li class="mt-auto">
								<a
									href="#"
									class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover: hover:"
								>
									<svg
										class="h-6 w-6 shrink-0 text-gray-400 group-hover:"
										fill="none"
