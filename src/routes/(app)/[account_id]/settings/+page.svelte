...
<h2 class="text-xl font-semibold flex flex-row justify-between mt-2">
...
<h2 class="text-xl my-4 font-semibold flex flex-row justify-between mt-2">
	<div class=" flex"><Blocks class="my-auto mr-2" />Integrations</div>
</h2>
<Card.Root>
	<Card.Header />
	<Card.Content>
		<Alert.Root class=" w-fit flex">
			<div>
				...
				<Alert.Description class="font-light text-sm hover:underline truncate"
