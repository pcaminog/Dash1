...
<div class="bg-white py-8">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-4xl text-center">
			<h2 class="text- font-semibold leading-7">Plands</h2>
		...
		<div class="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
			<section class="p-8">
				...
				<Button variant="default" class=" mt-8 w-full  bg-blue hover:bg-blue-foreground"
					>Buy plan</Button
				>
			...
			<section class="p-8 rounded-xl bg-gray-400/5 ring-1 ring-inset ring-gray-200">
				...
				<a
					...
					class="mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 bg-blue-600 text-white hover:bg-blue-500"
					>Buy plan</a
				>
				<ul role="list" class="mt-10 space-y-4 text-sm leading-6 text-gray-900">
					<li>
			...
			<section class="p-8">
				...
				<a
					...
					class="mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 text-blue ring-1 ring-inset ring-blue-200 hover:ring-blue-300"
					>Buy plan</a
				>
				<ul role="list" class="mt-10 space-y-4 text-sm leading-6 text-gray-900">
					<li>
